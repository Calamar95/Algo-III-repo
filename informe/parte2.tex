...
\minipage{0.8\textwidth}
  ...
  \caption{{\small Comparación del peor caso con O((n/50)log(n)) y O((n/70)log(n)).}} \label{ej2-peor-caso}
\endminipage
...
\minipage{0.8\textwidth}
  ...
  \caption{{\small Comparación del mejor caso con O((n/70)log(n)).}} \label{ej2-mejor-caso}
\endminipage
