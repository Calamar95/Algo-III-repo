...
\minipage{0.8\textwidth}
  ...
  \caption{{\small Comparación del peor caso con O((n/70)log(n)).}} \label{ej2-peor-caso}
\endminipage
...
\minipage{0.8\textwidth}
  ...
  \caption{{\small Comparación del mejor caso con O((n/50)log(n)) y O((n/70)log(n)).}} \label{ej2-mejor-caso}
\endminipage
...
\minipage{0.8\textwidth}
  ...
  \caption{{\small Comparación de un caso random con O((n/70)log(n)).}} \label{ej2-random-caso}
\endminipage
...
\minipage{0.8\textwidth}
  ...
  \caption{{\small Comparación de los tres casos anteriores con O((n/50)log(n)).}} \label{ej2-todos-casos}
\endminipage
